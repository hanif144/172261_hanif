...
public class TraderMain {
		...
		public static void main(String[] args) {
			...
			list.add(new Trader("haneef", "Pune"));
			list.add(new Trader("gayaz","Hyderabad"));
			list.add(new Trader("rehan", "Indore"));
			list.add(new Trader("pavan", "Pune"));
			list.add(new Trader("sai", "Indore"));
			list.add(new Trader("bunty", "Bangalore"));
			list.add(new Trader("bargav", "Pune"));
			list.add(new Trader("ashok", "Indore"));
			list.add(new Trader("nagarjuna", "Pune"));
			list.add(new Trader("yeshwant", "Indore"));
